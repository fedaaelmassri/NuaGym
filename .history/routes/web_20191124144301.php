...
/**  Start Member Dashboard */
    ...
    //  Route::get('member/events',  'frontend\EventsController@eventsformember')->name('memberevent');
     ...
     Route::namespace('frontend')->prefix('/member')->middleware(['members'])->group(function (){
        Route::get('/', 'MemberprofileController@edit')->name('admin.userprofile.edit');
     ...
     Route::put('{id}', 'MemberprofileController@update')->name('admin.userprofile.update');
