...
/**  Start Member Dashboard */
     Route::get('member/dashboard',  'frontend\ProgramsController@programsformember')->name('memberdashboard')->middleware(['members']);
     Route::get('member/events',  'frontend\EventsController@eventsformember')->name('memberevent')->middleware(members::class);
