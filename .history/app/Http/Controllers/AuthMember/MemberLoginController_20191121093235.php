            ...
            if(Session::has('EventId')){
                ...
                if(!$report){
                    ...
                    if($event->save()){
                        ...
                        return redirect( route('memberevent') )->with([ 'message' => sprintf('Great! You have Successfully loggedin And successfully participated in the program "%s"', $event->event_id),
                        'alert-type' => 'success'
                        ]);
                        }
                    }else{
