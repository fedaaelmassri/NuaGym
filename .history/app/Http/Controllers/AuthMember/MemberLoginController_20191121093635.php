            ...
            if(Session::has('EventId')){
                ...
                if(!$report){
                    ...
                    if($event->save()){
                        ...
                        return redirect( route('memberevent') )->with([ 'message' => sprintf('Great! You have Successfully loggedin And successfully participated in the Event "%s"', $event->event_id),
                        'alert-type' => 'success'
                        ]);
                        }
                    }else{
                        Session::forget('EventId');
                         return redirect( route('memberevent') )->withSuccess('aelredy');

                        //  ->with([ 'message' => sprintf('Great! You have Successfully loggedin And Aleardy participated in the Event ' ),
                        // 'alert-type' => 'success'
                        // ]);
