    ...
    */
    ...
    public function postRequest(array $data)
    {
      ...
      "club_id"=> 37662,
        ...
        $response = $client->post('https://api.virtuagym.com/api/v1/club/37662/member?api_key=8gsl4CxGyN4fMrM41LAfjNjxDkupxLcUxWp8tgygsv&club_secret=CS-37662-ACCESS-Q1mD1XFNBzuF0WYmfEwKKDVbM',$headers,$Nbody);
