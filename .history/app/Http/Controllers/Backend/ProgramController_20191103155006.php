...
class ProgramController extends Controller
{
     ...
     public function AddCoach($p_id, $c_id)
    {
        ...
        $CoachesPrograms = CoachesPrograms::create(
            ['program_id' => $p_id,
           'coache_id' => $c_id ]
        );
     ...
     public function checkfoundcoach($p_id, $c_id){
        $CoachesPrograms=CoachesPrograms::where('program_id', $p_id)->where('coache_id', $c_id)->first();
        if($CoachesPrograms){
