...
{
    //
    public $base_url='https://apidemo.myfatoorah.com';
    protected $pymentconfig = config('paymentconfig');
  ...
  "ErrorUrl": "http://www.bing.com"
        ...
        $soap_do     = curl_init();
       curl_setopt($soap_do, CURLOPT_URL, $base_url."/ApiInvoices/CreateInvoiceIso");
      ...
      if(isset($_GET['paymentId']))
       ...
       $password= 'api12345*';
       $url = $base_url.'/ApiInvoices/Transaction/'.$id;
       $soap_do1 = curl_init();
