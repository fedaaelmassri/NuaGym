...
class PaymentController extends Controller
{
    ...
    {
     $data = config('paymentconfig');
      exit;

    }
    public function iniatPayment(){
        $curl = curl_init();
    ...
    public function makePyment(){
       $this->pymentconfig = config('paymentconfig');
        if(isset($this->pymentconfig['access_token']) && !empty($this->pymentconfig['access_token'])){
            $access_token=$this->pymentconfig['access_token'];
        }else{
          $access_token='';
        }
        if(isset($this->pymentconfig['token_type']) && !empty($this->pymentconfig['token_type'])){
       ...
       curl_close($soap_do);
        ...
        $("#paymentRedirect").click(function(e) {
          window.location="'.$RedirectUrl.'";
            ...
            //print_r($json);
          print_r("Error: ".$this->pymentconfig['error']."<br>Description: ".$this->pymentconfig['error_description']);
          }
