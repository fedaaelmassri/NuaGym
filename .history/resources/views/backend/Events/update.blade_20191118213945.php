        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <textarea class="form-control" id="duration" name="duration"   placeholder="Duration" value="{{$Event->duration }}" class="form-control @error('duration') is-invalid @enderror"></textarea>
                @error('duration')
                    <p class="text-danger">{{$message}}</p>
                    @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input type="time"  value="{{$Event->time }}" class="form-control @error('time') is-invalid @enderror form-control" id="time" name="time"   >
