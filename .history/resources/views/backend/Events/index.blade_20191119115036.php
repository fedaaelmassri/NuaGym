            ...
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title"> Events</h4>
                    ...
                    <a href="{{route('admin.Event.create')}}" class="btn btn-brand btn-elevate btn-icon-sm float-right">
                    ...
                    <tr id="row-{{$events->id}}">
                        ...
                        <td class="text-center">
                            ...
                            <td nowrap="">
                                    ...
                                    <a href="{{route('admin.Program.edit' , [ 'id' => $events->id ])}}" class="btn btn-md btn-primary btn-simple " title="Edit"> Edit<i class="la la-edit"></i>
                                    </a>
                                    ...
                                    <a href="#coacheModal" class=" btn btn-md btn-danger btn-simple "  id="events-{{$events->id}}"  onclick="geteventsId({{$events->id}});getAllCoach({{$events->id}})"  data-toggle="modal"> Coaches<i class="la la-trash"></i>
                                    </a
