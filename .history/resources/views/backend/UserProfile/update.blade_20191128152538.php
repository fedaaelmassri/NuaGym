...
<div class="row">
        ...
        <div class=" col-md-offset-2 col-md-8  col-md-offset-2 ">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                     <form class="form-horizontal" method="POST" action="{{ route('member.memberprofile.update',['id'=> Auth::guard('members')->user()->id]) }}">
                    @method('PUT')
                        @csrf
                    ...
                    <div class="box-footer">
                        <a href="{{route('memberdashboard')}}" class="btn btn-default">Cancel</a>
