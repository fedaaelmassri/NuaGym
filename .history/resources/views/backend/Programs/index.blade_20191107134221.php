    ...
    var url='{{URL::to('/admin/programs')}}';
         ...
         $.ajax({
            ...
            '  <td  class=" text-center" style="color:#000000 !important;">'+
                     ...
                     '<a      class="d-block"  href="#" id="addcoach-'+obj.id+'"  onclick="addcoache('+obj.id+')"> <i class="fas fa-check-circle text-success"></i></a>'+

           '<a href="#" class="d-none"    id="removecoach-'+obj.id+'" onclick="deletcoach('+obj.id+')"  > <i class="fas fa-times-circle text-danger"></i></a>'+
                '</td></tr>');
