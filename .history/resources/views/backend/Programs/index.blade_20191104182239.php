    ...
    <div class="table-responsive ps  " id="coachtable">
                  <table class="table tablesorter  " id="">
                    <thead class=" text-primary ">
                      ...
                      <th  class="blackcolor text-center" rowspan="1" colspan="1" style="width: 68.5px;" aria-label="Actions">Actions <?php $program_id=Request::input('programid');
 echo "hihi".$program_id."hi" ; ?></th>
