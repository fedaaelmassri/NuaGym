...
<a href="#" class=" btn btn-md btn-danger btn-simple sa-remove deleteRecored"  id="{{$program->id}}" onclick="delet_rec({{$program->id}})"  data-toggle="modal"> Delete<i class="la la-trash"></i>
</a>
