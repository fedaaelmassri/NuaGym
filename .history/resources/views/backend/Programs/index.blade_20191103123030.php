...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade " id="coacheModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <input type="text" id="coachid" name="coachid" value="" />
                    ...
                    <tr id="row-{{$program->id}}" >
                        ...
                        <td  class=" text-center" style="color:#000000 !important;">
                            ...
                            <td nowrap=""   style="color:#000000 !important;">
                                    ...
                                    <a href="{{route('admin.Program.edit' , [ 'id' => $coaches->id ])}}" class="btn btn-md btn-primary btn-simple " title="Edit"> Edit<i class="la la-edit"></i>
                                    </a>

                                    <a href="#" class=" btn btn-md btn-danger btn-simple sa-remove deleteRecored"  id="{{$coaches->id}}" onclick="deletrec({{$program->id}})"  data-toggle="modal"> Delete<i class="la la-trash"></i>
                                    </a>
