                    ...
                    <tr id="row-{{$coaches->id}}" >
                        ...
                        <td  class=" text-center" style="color:#000000 !important;">
                            ...
                            <td nowrap=""   style="color:#000000 !important;">
                                @if(App\CoachesPrograms::where('program_id', $p_id)->where('coache_id',$coaches->id))
                                    <a href="#"  onclick="addcoache({{$coaches->id}})"> <i class="fas fa-check-circle text-success"></i>
                                    </a>

                                    <a href="#" class=""  id="{{$coaches->id}}" onclick="deletcoach({{$coaches->id}})"  > <i class="fas fa-times-circle text-danger"></i>
                                    </a>
                                @endif
