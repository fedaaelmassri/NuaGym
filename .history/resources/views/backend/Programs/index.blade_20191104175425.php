                    ...
                    <tr id="row-{{$program->id}}">
                        ...
                        <td class="text-center">
                            ...
                            <td nowrap="">
                                    ...
                                    <a href="#coacheModal" class=" btn btn-md btn-danger btn-simple "  id="program-{{$program->id}}"  onclick="getProgramId({{$program->id}});checkfoundcoach({{$program->id}})"  data-toggle="modal"> Coaches<i class="la la-trash"></i>
                                    </a
...
// $program_id= "<script language=javascript> document.write($('#programid').val());</script>";
dd("<script>document.writeln($('#programid').val());</script>");
// $coach=App\CoachesPrograms::where('program_id',)
 ?>
    <div class="table-responsive ps  " id="coachtable">
                  <table class="table tablesorter  " id="">
                    <thead class=" text-primary ">
                      ...
                      <th  class="blackcolor text-center" rowspan="1" colspan="1" style="width: 68.5px;" aria-label="Actions">Actions</th>

                    </tr></thead>
                 <tbody>
                     @foreach($coaches as $coaches)

                    <tr id="row-{{$coaches->id}}" >
                        ...
                        <td  class=" text-center" style="color:#000000 !important;">
                             <img src="{{asset('storage/' . $coaches->image )}}" height="40" width="50">
                            </td>
                            <td nowrap=""   style="color:#000000 !important;">

                                     <a    href="#" id="addcoach-{{$coaches->id}}"  onclick="addcoache({{$coaches->id}})"> <i class="fas fa-check-circle text-success"></i>
                                    </a>

                                    <a href="#" class=""   id="removecoach-{{$coaches->id}}" onclick="deletcoach({{$coaches->id}})"  > <i class="fas fa-times-circle text-danger"></i>
                                    </a>
                                     </td>
                    </tr>
                    @endforeach
