                    ...
                    <tr id="row-{{$coaches->id}}" >
                        ...
                        <td  class=" text-center" style="color:#000000 !important;">
                            ...
                            <td nowrap=""   style="color:#000000 !important;">
                                     <a  style="display:none;" href="#" id="addcoach-{{$coaches->id}}"  onclick="addcoache({{$coaches->id}})"> <i class="fas fa-check-circle text-success"></i>
                                    </a>

                                    <a href="#" class=""  style="display:none;" id="removecoach-{{$coaches->id}}" onclick="deletcoach({{$coaches->id}})"  > <i class="fas fa-times-circle text-danger"></i>
                                    </a>
