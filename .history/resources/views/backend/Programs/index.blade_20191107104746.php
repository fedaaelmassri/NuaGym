   ...
   var url='{{URL::to('/admin/programs')}}';
         ...
         $.ajax({
            ...
            '  <td  class=" text-center" style="color:#000000 !important;">'+
                       ...
                       '<a    href="#" id="addcoach-{{$coaches->id}}"  onclick="addcoache('+obj.id+')"> <i class="fas fa-check-circle text-success"></i></a>'+

           '<a href="#" class=""   id="removecoach-{{$coaches->id}}" onclick="deletcoach('+obj.id+')"  > <i class="fas fa-times-circle text-danger"></i></a>'+
'</td>'
                             '</tr>');
            });
