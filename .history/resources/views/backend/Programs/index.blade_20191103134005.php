                    ...
                    <tr id="row-{{$program->id}}">
                        ...
                        <td class="text-center">
                            ...
                            <td nowrap="">
                                    ...
                                    <a href="#coacheModal" class=" btn btn-md btn-danger btn-simple "  id="program-{{$program->id}}"  onclick="getProgramId({{$program->id}})"  data-toggle="modal"> Coaches<i class="la la-trash"></i>
                                    </a
    ...
    <div class="modal fade " id="coacheModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                <input type="hidden" id="progaramid" name="progaramid" value="" />
                    ...
                    <tr id="row-{{$program->id}}" >
                        ...
                        <td  class=" text-center" style="color:#000000 !important;">
                            ...
                            <td nowrap=""   style="color:#000000 !important;">
                                    ...
                                    <a href="{{route('admin.Program.edit' , [ 'id' => $coaches->id ])}}" > <i class="fas fa-check-circle text-success"></i>
                                    </a>

                                    <a href="#" class="  sa-remove deleteRecored"  id="{{$coaches->id}}" onclick="deletrec({{$program->id}})"  data-toggle="modal"> <i class="fas fa-times-circle text-danger"></i>
                                    </a>
...
function addcoache(c_id){
    var m_url='admin/programs/addcoach/'
    var p_id= $("#progaramid").val();
    $.ajax({
            url:deleteurl ,
            type: 'POST',
