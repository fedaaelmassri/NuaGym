...
<div class="content">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add Coache') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin.Coache.update') }}">
                    method('PUT')
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text"     value="{{$coache->name }}"  class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="identity" class="col-md-4 col-form-label text-md-right">{{ __('Identity Number') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{$coache->password}}" required autocomplete="new-password">
