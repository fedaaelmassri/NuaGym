...
<a href="{{route('admin.Program.edit' , [ 'id' => $coache->id ])}}" class="btn btn-md btn-primary btn-simple " title="Edit"> Edit<i class="la la-edit"></i>
</a>

<a href="#" class=" btn btn-md btn-danger btn-simple sa-remove deleteRecored"  id="{{$coache->id}}"> Delete<i class="la la-trash"></i>
</a>
