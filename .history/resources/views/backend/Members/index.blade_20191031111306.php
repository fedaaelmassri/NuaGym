...
<a href="{{route('admin.Member.Activate',['id'=>$member->id])}}" class=" btn btn-md btn-danger btn-simple "  id="{{$member->id}}"> @if({{$member->status}}==='0') Active @else Block @endif <i class="la la-trash"></i>
</a>
