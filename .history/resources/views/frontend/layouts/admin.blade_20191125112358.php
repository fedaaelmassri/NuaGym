    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          <li>
            <a href="{{route('member.memberprofile.edit')}}">
        ...
        <div class="modal-footer">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  ...
                  <li class="nav-link">
                    <a href="{{route('home')}}" class="nav-item dropdown-item">Home </a>
                  </li>
                  <li class="nav-link">
                  ...
                  <li class="nav-link">
                    <a href="{{route('member.logout')}}" class="nav-item dropdown-item">Log out</a>
                  </li>
                </ul>
              </li>
