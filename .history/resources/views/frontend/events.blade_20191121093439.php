...
<!--------- Start section1-->
  ...
  <div class="row section2">
      ...
      <div class="col-5 ">
          <!-- <div class="startbtn"> -->
          <a class="btn  btn-lg yellowbtnsec2 subscribe-btn " onclick="subscripeEvent();">
                Subscribe
          </a>
        <!-- </div> -->
        </div>
...
function subscripeEvent(){
     var url='{{URL::to('/subscripeEvent')}}';
  var eventid= $("#eventid").val();
  if(eventid!=''){
    var m_url=url+'/'+eventid;
    window.location.href =m_url;
  }
  else{
      alert("Please select an event to subscribe")
  }
