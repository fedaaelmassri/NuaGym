  ...
  <div class="row section1">
          <!-- <div class="col-6"> -->
             ...
             <div class="col-4">
                 ...
                 <div id="program-{{$programs->id}}" class="rectangle "  onclick="getid({{$programs->id}})"  >
                        <div class="circle  ">
...
//     $('#program-'+id).hover(function(){
//         if(activeclass==false){
//   $(this).addClass('rectangle-active');
//         }
//         else{
//             $(this).removeClass('rectangle-active');
...
//   });
  ...
  }else{            $(this).removeClass('rectangle-active');
}
    $('#proid').val(id);
}
...
function removeactive(id){
    ...
    // var activeclass=document.getElementById("program-"+id).className = "rectangle-active";
