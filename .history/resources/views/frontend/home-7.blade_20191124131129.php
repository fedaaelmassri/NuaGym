          ...
          <!-- <div class="col-6"> -->
             ...
             <div class="col-4 ">
                ...
                <div class="row mt-40">
                     ...
                     <div class="col-6">
                     <a class="btn  btn-lg  stepbtn cancelbtn" href="{{ URL::previous() }}">
                            BACK
                   </a>
             </div>
                      </div>
...
alert('fffffff'+cid);
var activeclass=document.getElementById("coache-"+cid).classList.contains('rectangle-active');
  if(activeclass==false){
    $(".rectangle.rectangle-active").removeClass("rectangle-active");

    $('#coache-'+cid).addClass('rectangle-active ');
  }else{
       $('#coache-'+cid).removeClass('rectangle-active');
          }
$('#coache_id').val(cid);
