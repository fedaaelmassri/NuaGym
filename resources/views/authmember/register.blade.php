...
<head>
    ...
    <link href="{{asset('public/assets/https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i')}}" rel="stylesheet">
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body ">
                    <h2 class="title">{{trans('lang.registration.registration_title')}} </h2>
                     <form method="POST" action="{{ route('member.post-registration') }}">
                        @csrf
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                <label class="label">{{trans('lang.registration.name_lbl')}} </label>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                <label class="label">{{trans('lang.registration.identity_lbl')}} </label>
                                    <input id="identity" type="text" class="input--style-4  @error('identity') autofocus is-invalid @enderror" name="identity" value="{{ old('identity') }}" required >
                                    @error('identity')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                <label class="label">{{trans('lang.registration.birthday_lbl')}} </label>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">{{trans('lang.registration.gender_lbl')}} </label>
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">{{trans('lang.registration.male_lbl')}}
                                            <input type="radio" checked="checked" name="gender" value="male">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio-container">{{trans('lang.registration.female_lbl')}}
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">{{trans('lang.registration.email_lbl')}} </label>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                <label class="label">{{trans('lang.registration.phone_lbl')}}</label>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                <label class="label">{{trans('lang.registration.city_lbl')}}</label>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                <label class="label">{{trans('lang.registration.country_lbl')}}</label>
                        ...
                        <div class="input-group">
                            <label class="label">{{trans('lang.registration.address_lbl')}}</label>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">{{trans('lang.registration.password_lbl')}} </label>
                                    <input class="input--style-4 @error('password') is-invalid autofocus @enderror" type="password" id="password" name="password" value="{{ old('password') }}" required >
                             ...
                             <div class="col-2">
                                <div class="input-group">
                                    <label class="label">{{trans('lang.registration.conf_password_lbl')}}</label>
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit">{{trans('lang.registration.submit_btn')}}</button>
                        </div>
                    </form>
                </div>
            </div>
