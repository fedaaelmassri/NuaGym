...
<div class="row">
        ...
        <div class=" col-md-offset-2 col-md-8  col-md-offset-2 ">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                        <form   class="form-horizontal" method="post" action="{{route('admin.Eventsport.store')}}" enctype="multipart/form-data" >
                        @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9 ">
                <input type="number"  class="form-control" id="required_subscribers" name="required_subscribers"    >
