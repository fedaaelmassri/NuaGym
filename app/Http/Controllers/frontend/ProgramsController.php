...
class ProgramsController extends Controller
{
    ...
    public function index($cid=null){
         if($cid==null){
            ...
            $Coache= Coaches::where('id', $cid)->with('programs')->get();
            foreach($Coache as $programforcoach)
             {
                $programs=$programforcoach->programs;
                }
   ...
   public function programsformember(){
    ...
    $programs = subscriptions::where('member_id', $mid)
    ->where('payable_type', 'program')
